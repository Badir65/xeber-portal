...
export default function DeleteCategoryButton({ id, name, newsCount }: Props) {
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-slate-900 border border-slate-800 rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl">
            ...
            <h3 className="text-lg font-semibold text-white text-center mb-2">Kateqoriyanı sil?</h3>
            <p className="text-slate-400 text-sm text-center mb-2">
              &quot;{name}&quot; kateqoriyası silinəcək.
            </p>
            {newsCount > 0 && (
              <p className="text-amber-400 text-sm text-center mb-4">
                ⚠️ Bu kateqoriyada {newsCount} xəbər var. Onlar da silinəcək!
              </p>
            )}
